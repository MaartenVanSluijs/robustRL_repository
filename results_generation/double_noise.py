...
def evaluate_agents(folder: str, render: bool, num_episodes: int):
    ...
    for noise_type in noise_types:
        ...
        variable_noise = list(set(noise_types) - set([noise_type]))
        print(variable_noise)

        evaluation.set_noise(variable_noise, 1.0, 10)
        ...
        results[f"no_{noise_type}"] = per_noise_results

    save_name = f"double_noise_{agent_type}_{env_name}"
