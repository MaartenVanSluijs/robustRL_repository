...
class RobustHopper(HopperEnv):
    def __init__(self, **kwargs):
        ...
        self.foot_geom_id = mujoco.mj_name2id(
        ...
        self.default_friction = self.model.geom_friction[self.foot_geom_id].copy()
    ...
    def reset_model(self):
        ...
        # --- Friction ---
        friction = self.default_friction[0] * np.random.uniform(
            1 - self.friction_scale, 1 + self.friction_scale
        )
        self.model.geom_friction[self.foot_geom_id, :] = [
